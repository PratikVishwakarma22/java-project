        ...
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">
              ...
              <a href="adminComplaints.jsp" class="list-group-item"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> Complaints <span class="badge"><%= count.getComplaintToYouCountManagerAdmin(id) %></span></a>
            </div>
              ...
              <div class="panel-body">
                ...
                <div class="col-md-3">
                  <div class="well dash-box">
                    ...
                    <div class="col-md-3">
                  <div class="well dash-box">
                      <h2><span class="glyphicon glyphicon-stats" aria-hidden="true"></span><%= count.getComplaintToYouCountManagerAdmin(id) %></h2>
                    <h4>Complaints</h4>
                  </div>
                </div>
              </div>
