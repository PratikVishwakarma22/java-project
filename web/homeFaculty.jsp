...
<%
    ...
    String categorySessionCheck=(String)session.getAttribute("category");
    if(session==null || !categorySessionCheck.equals("faculty") )
    {
    ...
    <div class="row">
      <div class="col-lg-2">
        <div class="card shadow-sm">
          ...
          <div class="card-body">
            <p class="mb-0" name="manager_id"><strong class="pr-1">Faculty ID:</strong><%= manager.getManager_id() %></p>
